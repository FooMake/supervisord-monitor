                ...
                <table class="table table-bordered table-condensed table-striped">
                    <tr><th colspan="4">
                        ...
                        <span class="server-btns">
                            <a href="index.php/control/stopall/<?php echo $name; ?>" class="btn btn-mini btn-inverse" type="button">Stop all</a>
                            <a href="index.php/control/startall/<?php echo $name; ?>" class="btn btn-mini btn-success" type="button">Start all</a>
                            <a href="index.php/control/restartall/<?php echo $name; ?>" class="btn btn-mini btn-primary" type="button">Restart all</a>
                        </span>
                    </th></tr>
                    <?php
                    $CI = &get_instance();
        ...
        echo '<span class="pull-right"><a href="index.php/control/clear/'.$name.'/'.$item_name.'" id="'.$name.'_'.$item_name.'" onclick="return false" data-toggle="popover" data-message="'.htmlspecialchars($check).
            '" data-original-title="'.$item_name.'@'.$name.'" class="pop btn btn-mini btn-danger"><img src="/img/alert_icon.png" /></a></span>';
                            ...
                            <td width="70" style="text-align: center">
                                ...
                                <a href="index.php/control/stop/<?php echo $name.'/'.$item_name;?>" class="btn btn-mini btn-inverse" type="button"><i class="icon icon-stop icon-white"></i></a>
                                <a href="index.php/control/restart/<?php echo $name.'/'.$item_name;?>" class="btn btn-mini btn-primary" type="button"><i class="icon icon-refresh icon-white"></i></a>
                                <?php } if($status=='STOPPED'){ ?>
                                <a href="index.php/control/start/<?php echo $name.'/'.$item_name;?>" class="btn btn-mini btn-success" type="button"><i class="icon icon-play icon-white"></i></a>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php
                    ...
                    <tr>
                        <td colspan=4>
                            ...
                            <a href="index.php/control/restartgroup/<?php echo $name.'/'.$group;?>" class="btn btn-mini btn-primary" type="button">
                                <?php echo $group ?> <i class="icon icon-refresh icon-white"></i>
                            </a>
                            <a href="index.php/control/startgroup/<?php echo $name.'/'.$group;?>" class="btn btn-mini btn-success" type="button">
                                <?php echo $group ?> <i class="icon icon-play icon-white"></i>
                            </a>
                        </td>
                    </tr>
                    <?php } ?>
